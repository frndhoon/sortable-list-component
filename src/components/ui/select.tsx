...
const SelectValue = ({ className, ...props }: React.ComponentProps<typeof SelectPrimitive.Value>) => {
	return <SelectPrimitive.Value data-slot="select-value" className={cn('text-inherit', className)} {...props} />;
};
	...
	return (
		...
		>
			...
			<SelectPrimitive.Icon asChild>
				<ChevronDownIcon className="h-[2rem] w-[2rem] text-blue-100 opacity-50" />
